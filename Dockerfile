# Docker-MicroDG-Geo-Tagging-Service
# VERSION 1.0
...
# that's me!
MAINTAINER David Brady, microdg.db@gmail.com
...
ADD target/scala-2.11/FYP-Geo-Tagging-Service-assembly-1.0.jar /app/server.jar
